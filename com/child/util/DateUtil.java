...
public class DateUtil {
	...
	private final static SimpleDateFormat sdfChDay = new SimpleDateFormat("yyyy年MM月dd日");
	...
	public static String getChDay() {
		return sdfChDay.format(new Date());
	}
